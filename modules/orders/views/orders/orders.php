...
<div class="container-fluid">
    ...
    <tr>
      ...
      <th class="dropdown-th">
        <div class="dropdown">
          ...
          <?php echo " <br> <span>Total $provider->totalCount</span>"; ?>
          <?php
          usort($counterSer, function ($a, $b) {
              return (int) ($a['cnt'] < $b['cnt']);
          });
          $itemArr = [];
          foreach ($counterSer as $serv) {
        ...
        <?= Html::dropDownList('service_id', [], $itemArr, ['label' => 'Please select']) ?>
        </div>
      </th>
  ...
  <div class="row">
    <div class="col-sm-8">
        ...
        ?>
        <?= Html::submitButton('Export CSV', ['class' => 'btn btn-default']) ?>
        <?php ActiveForm::end(); ?>
      <nav>
